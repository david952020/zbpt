...
! function(e) {
    ...
    r.prototype.cache = n, r.prototype.define = function(e, t) {
        ...
        return o && (t = e, e = []), !layui["layui.zy"] && layui["layui.mobile"] ? a.call(r) : (r.use(e, a), r)
        ...
        var d = e[0],
            m = 0;
        if (l = l || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || layui["layui.zy"] && u[d] || !layui["layui.zy"] && layui["layui.mobile"] && u[d]) return s(), p;
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    F.prototype.config = {
            ...
            return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ? b() : 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), b(), c.renderTotal(y, h), void(s.page && (s.page = t.extend({
                ...
                count: o,
                limit: s.limit,
                limits: s.limits || [ 10, 20, 30, 50, 60, 70, 80, 1000, 2000],
                groups: 3,
        ...
        function() {
            ...
            }()), s.download = (l.title || "["+planid+"]"+"["+planer+"]"+"["+strtime+"]"+"_" + (l.index || "")) + "." + i, document.body.appendChild(s), s.click(), void document.body.removeChild(s))
        }, d.resize = function(e) {
            if (e) {
                var t = s(e);
                if (!t) return;
