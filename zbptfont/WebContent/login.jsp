...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>云都海鹰无人机植保监管平台登录界面</title>
		<link href="zbptf/css/default.css" rel="stylesheet" type="text/css" />
		<!--必要样式-->
		<link href="zbptf/css/styles.css" rel="stylesheet" type="text/css" />
		<link href="zbptf/css/demo.css" rel="stylesheet" type="text/css" />
		<link href="zbptf/css/loaders.css" rel="stylesheet" type="text/css" />
	</head>

	<body>
		<div class='login'>
			<div class='login_title'>
				<span>云都海鹰植保监管平台</span>
			</div>
			<div class='login_fields'>
				<div class='login_fields__user'>
					<div class='icon'>
						<img alt="" src='zbptf/img/user_icon_copy.png'>
					</div>
					<input name="login" placeholder='用户名' maxlength="11" type='text' autocomplete="off" />
					
					<div class='validation'>
						<img alt="" src='zbptf/img/tick.png'>
					</div>
				</div>
				<div class='login_fields__password'>
					<div class='icon'>
						<img valt="" src='zbptf/img/lock_icon_copy.png'>
					</div>
					<input name="pwd" placeholder='密码' maxlength="6" type="password" autocomplete="off" >
		...
		<link href="css/hidepassword.css" rel="stylesheet" type="text/css" /> -->
		<!-- <script type="text/javascript" src="js/hidepassword.js"></script> -->
		<script type="text/javascript" src="zbptf/js/jquery.min.js"></script>
		<script type="text/javascript" src="zbptf/js/jquery-ui.min.js"></script>
		<script type="text/javascript" src='zbptf/js/stopExecutionOnTimeout.js?t=1'></script>
		<script type="text/javascript" src="zbptf/layui/layui.js"></script>
		<script type="text/javascript" src="zbptf/js/Particleground.js"></script>
		<script type="text/javascript" src="zbptf/js/Treatment.js"></script>
		<script type="text/javascript" src="zbptf/js/jquery.mockjax.js"></script>
			...
			layui.use('layer', function() {
				...
				$('input[type="button"]').click(function() {
					...
					if(login == '') {
						...
						$.ajax({
							  type: 'POST',
							  url: "http://ydhy.xyz:8687/zbpth/zbpt/login",
							  data: {"user_admin":login,"user_pwd":pwd},
							  async:false,
							  success:function(data) {
								var flag=data[1];
								/* alert(flag); */
						if (flag=='2'){
							 window.location.href = "zbptf/uplane_place.html?useradmin="+login; 
							alert("登录成功");
						}else if(flag=='3'){
							window.location.href = "zbptf/index.html?useradmin="+login;
							alert("登录成功");
						}else{
							alert("账号或密码错误，请确认！！")
						}
		...
		<script type="text/javascript" src="zbptf/img/ThreeWebGL.js"></script>
		<script type="text/javascript" src="zbptf/img/ThreeExtras.js"></script>
		<script type="text/javascript" src="zbptf/img/Detector.js"></script>
		<script type="text/javascript" src="zbptf/img/RequestAnimationFrame.js"></script>
