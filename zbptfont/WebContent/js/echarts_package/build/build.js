...
function run() {
    ...
    commander
        ...
        .description([
            ...
            egIndent + 'node build/build.js --lang "my/lang.js" -i "my/navigation.js" -o "my/bundle.js"'
                + '\n' + descIndent + '# Take `<cwd>/my/navigation.js` as input and generate `<cwd>/my/bundle.js`,'
