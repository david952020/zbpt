  ...
  function layui_diy(html)
{
    ...
    {
        //let a;//获取ajax返回的数据
       let pla=$.ajax({url:"http://127.0.0.1:3306/zbpt/planlist",method:'post'});
        //layui模块
    ...
    {
		console.log('-------test1');
		let err=$.ajax({url:"http://127.0.0.1:3306/zbpt/errordata",method:'post'});
        //layui模块
        layui.use(['table','element','layer'], function() {
           /* var  key =1;*/
            var table = layui.table;
    ...
    {
		//let a;//获取ajax返回的数据
        let zyt=$.ajax({url:"http://127.0.0.1:3306/zbpt/jobaccount",method:'post'});
        //layui模块
...
//            var  key =1;
            ...
            var demo_op ={
                ...
                data:JSON.parse(zyt.responseText).data,
            };
            table.render(demo_op);//渲染表格
            laydate.render({
		    elem: '#dateReload'
		      ...
		      table.on('checkbox(demo)', function(obj){
		  	 ...
		  	 var $ = layui.$, active = {
			    ...
			    reload: function(){
			      ...
			      /*console.log(teamReload.val());
			      console.log(planReload.val());
			      console.log(planerReload.val());
			      console.log(dateReload.val());*/
			      ...
			      url:"http://127.0.0.1:3306/zbpt/Teamchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			      ...
			      },'data');}else if(plan_id !=null && plan_id !='' && team_id =='' && planer_id =='' && start_time =='' ){
			      table.reload('testReload', {
			      url:"http://127.0.0.1:3306/zbpt/Planchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			      ...
			      },'data');}else if(planer_id !=null && planer_id !='' && plan_id =='' && team_id =='' && start_time =='' ){
			      table.reload('testReload', {
			      url:"http://127.0.0.1:3306/zbpt/Planerchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			       where: {
			      ...
			      },'data');}else if(start_time !=null && start_time !='' && plan_id =='' && team_id =='' && planer_id ==''){
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Startimechk",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Teamplan",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Teamplaner",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Teamtime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Planplaner",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Planertime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:3306/zbpt/Plantime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
...
//			      table.reload('testReload', {
//			      url:"http://127.0.0.1:3306/zbpt/Jobchk",
//			      method:'post',
//			       page: {
//			          curr: 1 //重新从第 1 页开始
//			        },
//			       where: {
////			       		team_id:teamReload.val(),
////			       		plan_id:planReload.val(),
////			       		planer_id:planerReload.val(),
////			       		start_time:dateReload.val(),
//						team_id,
//						plan_id,
//						planer_id,
//						start_time,
...
//			      },'data');
			    ...
			    getCheckData: function(){ //获取选中数据
					       ...
					       /*layer.alert(jc);*/
						       let d=$.ajax({url:'http://127.0.0.1:3306/zbpt/flydata'
							    	,type:'post'
							        ,data:{"jia_ci":jc}
							        ,dataType:"json"
							        ,async:false
							        ,success:function (res) {
							         ...
							         /* console.log(d); */
									/*var e= JSON.parse(d.responseText).data; */
									/*var planid =e[0].plan_id;
									var planerid =e[0].planer_id;
									var starttime =e[0].start_time;
									let namet ="["+planid+"]"+"["+planerid+"]"+"["+starttime+"]";	*/
									/*console.log(JSON.parse(d.responseText).data[0].plan_id);*/
						         };
...
//                content:'http://www.baidu.com' //这里content是一个普通的String
//            };
...
//                        // setTimeout(function (){//重新加载表格数据
//                        //     let b=$.ajax({async:false,url:"http://144.123.30.218:5000/tongji.json"});
//                        //     demo_op.data=JSON.parse(b.responseText).data;
//                        //     table.render(demo_op);
//                        // },1);
//                        break;
//                    }
...
//                }
    ...
    {
		var usertable=$.ajax({url:"http://127.0.0.1:3306/zbpt/useradmin",method:"post"});
        ...
        layui.use(['table','element','layer'], function() {
            ...
            var demo_op ={
               ...
               height: 812,
                ...
                data: JSON.parse(usertable.responseText).data
            };
                    	...
                    	layer.prompt({
					        ...
					        ,value: data.team_user
					      	...
					      	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:3306/zbpt/bjuser",method:"post",//url
...
//                    	console.log(idc);
                        	...
                        	,success: function(layero){
                                ...
                                btn.find('.layui-layer-btn0').click(function () {
                                	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:3306/zbpt/Deluser",method:"post",//url
                                        data:{"id":idc},
                                        dataType:"json",
                                        async:false,
                                        //contentType:'application/json;charset=UTF-8',
    ...
    {
       var teamtable=$.ajax({url:"http://127.0.0.1:3306/zbpt/teamadmin",method:"post"});
        //console.log(b);
        //layui模块
        layui.use(['table','element','layer'], function() {
            var  key =1;
            ...
            var demo_op ={
                ...
                data: JSON.parse(teamtable.responseText).data
            };
            table.render(demo_op);//渲染表格
            $("#a4").hide();
            $("#a3").hide();
                    	...
                    	layer.prompt({
					        ...
					        ,value: data.team_user
					      	...
					      	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:3306/zbpt/bjteam",method:"post",//url
                        	...
                        	,success: function(layero){
                                ...
                                btn.find('.layui-layer-btn0').click(function () {
                                	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:3306/zbpt/DelTeam",method:"post",//url
                                        data:{"id":ids},
                                        dataType:"json",
                                        async:false,
                                        //contentType:'application/json;charset=UTF-8',
