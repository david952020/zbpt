  ...
  function layui_diy(html)
{
    ...
    {
        //let a;//获取ajax返回的数据
       let pla=$.ajax({url:"http://ydhy.xyz:8687/zbpth/zbpt/planlist",method:'post'});
        //layui模块
        ...
        layui.use(['table','element','layer'], function() {
           ...
           /* var layer = layui.layer;*/
             table.render({
                ...
                data: res.text(err.responseText).data
    ...
    {
		var usertable=$.ajax({url:"http://ydhy.xyz:8687/zbpth/zbpt/useradmin",method:"post"});
...
//                    	console.log(idc);
    ...
    {
       var teamtable=$.ajax({url:"http://ydhy.xyz:8687/zbpth/zbpt/teamadmin",method:"post"});
        //console.log(b);
        //layui模块
        layui.use(['table','element','layer'], function() {
            var  key =1;
