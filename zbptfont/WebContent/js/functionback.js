  ...
  function layui_diy(html)
{
    ...
    {
        //let a;//获取ajax返回的数据
       let pla=$.ajax({url:"http://127.0.0.1:8788/zbpth/zbpt/planlist",method:'post'});
        //layui模块
    ...
    {
		console.log('-------test1');
		let err=$.ajax({url:"http://127.0.0.1:8788/zbpth/zbpt/errordata",method:'post'});
        //layui模块
        layui.use(['table','element','layer'], function() {
           /* var  key =1;*/
            var table = layui.table;
    ...
    {
		//let a;//获取ajax返回的数据
        let zyt=$.ajax({url:"http://127.0.0.1:8788/zbpth/zbpt/jobaccount",method:'post'});
        //layui模块
		      ...
		      table.on('checkbox(demo)', function(obj){
		  	 ...
		  	 var $ = layui.$, active = {
			    ...
			    reload: function(){
			      ...
			      url:"http://127.0.0.1:8788/zbpth/zbpt/Teamchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			      ...
			      table.reload('testReload', {
			      url:"http://127.0.0.1:8788/zbpth/zbpt/Planchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			      ...
			      table.reload('testReload', {
			      url:"http://127.0.0.1:8788/zbpth/zbpt/Planerchk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			       where: {
			      	...
			      	table.reload('testReload', {
			      url:"http://127.0.0.1:8788/zbpth/zbpt/Startimechk",
			      method:'post',
			       page: {
			          curr: 1 //重新从第 1 页开始
			        },
			       where: {
			      ...
			      },'data');}else if(team_id !='' && plan_id !='' && planer_id =='' && start_time ==''){
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Teamplan",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Teamplaner",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Teamtime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Planplaner",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Planertime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
			      	...
			      	table.reload('testReload', {
				      url:"http://127.0.0.1:8788/zbpth/zbpt/Plantime",
				      method:'post',
				       page: {
				          curr: 1 //重新从第 1 页开始
				        },
...
//			      table.reload('testReload', {
//			      url:"http://127.0.0.1:8788/zbpth/zbpt/Jobchk",
//			      method:'post',
//			       page: {
//			          curr: 1 //重新从第 1 页开始
//			        },
...
//                }
    ...
    {
		var usertable=$.ajax({url:"http://127.0.0.1:8788/zbpth/zbpt/useradmin",method:"post"});
                    	...
                    	layer.prompt({
					        ...
					        ,value: data.team_user
					      	...
					      	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:8788/zbpth/zbpt/bjuser",method:"post",//url
...
//                    	console.log(idc);
                        	...
                        	,success: function(layero){
                                ...
                                btn.find('.layui-layer-btn0').click(function () {
                                	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:8788/zbpth/zbpt/Deluser",method:"post",//url
                                        data:{"id":idc},
                                        dataType:"json",
                                        async:false,
                                        //contentType:'application/json;charset=UTF-8',
    ...
    {
       var teamtable=$.ajax({url:"http://127.0.0.1:8788/zbpth/zbpt/teamadmin",method:"post"});
        //console.log(b);
        //layui模块
        layui.use(['table','element','layer'], function() {
            var  key =1;
                    	...
                    	layer.prompt({
					        ...
					        ,value: data.team_user
					      	...
					      	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:8788/zbpth/zbpt/bjteam",method:"post",//url
                        	...
                        	,success: function(layero){
                                ...
                                btn.find('.layui-layer-btn0').click(function () {
                                	$.ajax({
                                		//几个参数需要注意一下
                                        type: "post",//方法类型
                                        url: "http://127.0.0.1:8788/zbpth/zbpt/DelTeam",method:"post",//url
                                        data:{"id":ids},
                                        dataType:"json",
                                        async:false,
                                        //contentType:'application/json;charset=UTF-8',
